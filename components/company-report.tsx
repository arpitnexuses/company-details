...
export function CompanyReport({ company, logo }: Props) {
  return (
    <div className="bg-gradient-to-br from-background via-background to-muted/20 min-h-screen">
      {/* Report Header */}
      <div className="relative bg-gradient-to-r from-primary via-primary to-primary/90 text-primary-foreground p-4 sm:p-6 lg:p-10 overflow-hidden">
        ...
        <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="flex-1 text-center sm:text-left">
            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-black mb-2 sm:mb-3 tracking-tight">{company.name}</h1>
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-4 lg:gap-6 text-xs sm:text-sm">
              <div className="flex items-center gap-1 sm:gap-2 bg-primary-foreground/10 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
                <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-green-400 rounded-full animate-pulse"></span>
                <span className="font-medium">{company.hq}</span>
              </div>
              <div className="bg-primary-foreground/10 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
      ...
      <div className="p-4 sm:p-6 lg:p-10 space-y-6 sm:space-y-8 lg:space-y-10">
        ...
        <div className="bg-gradient-to-br from-card via-card to-muted/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border/50 backdrop-blur-sm">
          <div className="flex items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
            <div className="w-1.5 sm:w-2 h-6 sm:h-8 lg:h-10 bg-gradient-to-b from-primary to-primary/70 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="bg-gradient-to-br from-card via-card to-card/80 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border/50 backdrop-blur-sm">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-gradient-to-b from-primary to-primary/70 rounded-full"></div>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-card-foreground">Company Information</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {/* Website Card */}
              <div className="group bg-card/50 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-red-500/50 hover:border-red-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 bg-red-500/10 rounded-md sm:rounded-lg flex items-center justify-center group-hover:bg-red-500/20 transition-colors duration-300">
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                  </div>
                  <h4 className="font-semibold text-card-foreground text-sm sm:text-base">Website</h4>
                </div>
                <a href={`https://${company.website}`} target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-600 font-medium text-xs sm:text-sm transition-colors group-hover:underline break-all">
                  {company.website}
                </a>
              </div>
              ...
              <div className="group bg-card/50 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-red-500/50 hover:border-red-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 bg-red-500/10 rounded-md sm:rounded-lg flex items-center justify-center group-hover:bg-red-500/20 transition-colors duration-300">
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 text-red-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href={`https://${company.companyLinkedIn}`} target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-600 font-medium text-xs sm:text-sm transition-colors group-hover:underline">
                  View Company
                </a>
              </div>
          ...
          <div className="bg-gradient-to-br from-card via-card to-card/80 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-border/50 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {/* Regulator Card */}
              <div className="group bg-card/50 backdrop-blur-sm rounded-xl p-5 border border-red-500/50 hover:border-red-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 shadow-lg">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 bg-red-500/10 rounded-lg flex items-center justify-center group-hover:bg-red-500/20 transition-colors duration-300">
        ...
        <div className="bg-card border border-border rounded-lg p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="border border-border rounded-lg p-4 bg-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                {/* Header */}
                ...
                {contact.linkedin && (
                  <a 
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors duration-200 font-medium text-sm"
                  >
        ...
        {company.additionalNotes && (
          <div className="bg-gradient-to-br from-card via-card to-card/80 rounded-2xl p-8 shadow-lg border border-border/50 backdrop-blur-sm">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-2 h-10 bg-gradient-to-b from-primary to-primary/70 rounded-full"></div>
        ...
        <div className="bg-gradient-to-br from-card via-card to-card/80 rounded-2xl p-8 shadow-lg border border-border/50 backdrop-blur-sm">
          ...
          <div className="bg-gradient-to-br from-primary/5 via-primary/3 to-accent/5 rounded-xl p-6 border border-primary/20 shadow-inner">
            <div className="prose prose-base max-w-none">
